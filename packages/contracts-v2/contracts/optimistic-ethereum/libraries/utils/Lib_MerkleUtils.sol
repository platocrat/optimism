...
contract Lib_MerkleUtils {
    uint256 constant MAX_TREE_HEIGHT = 160;
    bytes32[MAX_TREE_HEIGHT] internal defaultHashes;

    constructor() {
        _generateDefaultHashes();
    }
    ...
    function _generateDefaultHashes()
        internal
    {
