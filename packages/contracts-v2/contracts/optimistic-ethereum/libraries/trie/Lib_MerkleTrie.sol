 ...
 * @title MerkleTrie
 */
contract Lib_MerkleTrie is Lib_ContractProxyResolver {
    /*
     * Data Structures
     */
    ...
    Lib_ByteUtils public libByteUtils;
    Lib_RLPReader public libRLPReader;
    Lib_RLPWriter public libRLPWriter;
    ...
    {
        libByteUtils = Lib_ByteUtils(resolve("Lib_ByteUtils"));
        libRLPReader = Lib_RLPReader(resolve("Lib_RLPReader"));
     ...
     */
    function _getSingleNodeRootHash(
        bytes memory _key,
        bytes memory _value
    )
        internal
