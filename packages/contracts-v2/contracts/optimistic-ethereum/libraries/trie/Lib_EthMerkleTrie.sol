...
import { Lib_OVMDataTypes } from "../utils/Lib_OVMDataTypes.sol";

/**
 * @notice Convenience wrapper for ETH-related trie operations.
 */
contract Lib_EthMerkleTrie is Lib_SecureMerkleTrie {
    /*
     * Contract Constants
     */
    ...
    ) Lib_SecureMerkleTrie(_libContractProxyManager) {}
        ...
        returns (bool)
    {
        ...
        Lib_OVMDataTypes.EVMAccount memory accountState = getAccountState(
            _address,
            _stateTrieWitness,
            _stateTrieRoot
        );
    ...
    function proveAccountState(
        address _address,
        Lib_OVMDataTypes.EVMAccount memory _accountState,
        Lib_OVMDataTypes.OVMProofMatrix memory _proofMatrix,
        bytes memory _stateTrieWitness,
        bytes32 _stateTrieRoot
    )
        public
        ...
        returns (bool)
    {
        return proveAccountState(
            _address,
            _accountState,
            Lib_OVMDataTypes.OVMProofMatrix({
                checkNonce: true,
                checkBalance: true,
    ...
    function proveAccountState(
        address _address,
        Lib_OVMDataTypes.OVMAccount memory _accountState,
        bytes memory _stateTrieWitness,
        bytes32 _stateTrieRoot
    )
        public
    ...
    function updateAccountState(
        ...
        returns (bytes32)
    {
        Lib_OVMDataTypes.EVMAccount memory newAccountState = _accountState;
        ...
        if (
            ...
            Lib_OVMDataTypes.EVMAccount memory oldAccountState = getAccountState(
                _address,
                _stateTrieWitness,
                _stateTrieRoot
            );
    ...
    function getAccountState(
        ...
        returns (Lib_OVMDataTypes.EVMAccount memory)
    {
        Lib_OVMDataTypes.EVMAccount memory DEFAULT_ACCOUNT_STATE = Lib_OVMDataTypes.EVMAccount({
            nonce: UINT256_NULL,
            balance: UINT256_NULL,
